...
def callback_worker(call):
    if call.data == 'accept':
        ...
        bot.register_next_step_handler(mes, get_name) #следующий шаг – функция get_name
        print('111111111111111111111')

    if call.data == "yes": #call.data это callback_data, которую мы указали при объявлении кнопки
        # print('call.message.from_user.id', call.message.from_user.id)
        ...
        if not str(name + surname + tlf) in username_lst:
            ...
            j.save() #код сохранения данных, или их обработки
